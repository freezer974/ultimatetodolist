<?php
    ...
    if ($_SERVER['REQUEST_URI'] == "/ultimatetodolist/" || $_SERVER['REQUEST_URI'] == "/" || $_SERVER['REQUEST_URI'] == "/ultimatetodolist/index.php"):
        $adresse = '';
    else:
        $adresse = '../';
    endif;
...
<html lang="fr">
    ...
    <body>
        ...
        <a class="navbar-brand" href="#"><img class="logo-nav" src="logo.png" alt="" /></a>
